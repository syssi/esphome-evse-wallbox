...
void EvseWallbox::on_status_data_(const std::vector<uint8_t> &data) {
  ...
  //
  // Status response
  // 0x01 0x03 0x12 0x00 0x20 0x00 0x00 0x00 0x01 0x00 0x05 0x00 0x00 0x00 0x12 0x00 0x01 0x00 0x00 0x00 0x00 0xF7 0xC
  //
  // Data:          0x00 0x20 0x00 0x00 0x00 0x01 0x00 0x05 0x00 0x00 0x00 0x12 0x00 0x01 0x00 0x00 0x00 0x00
  //
  //
  // *Data*
  //
...
void EvseWallbox::update() {
  ...
  if (this->enable_fake_traffic_) {
    ...
    // Status frame
    this->on_modbus_data(
        {0x00, 0x20, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0x00, 0x00, 0x00, 0x12, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00});
  }
}
